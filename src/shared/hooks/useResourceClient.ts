...
export const useResourceClient = (): Record<
  ResourceNames,
  ApolloClient<Record<string, unknown>> | undefined
> => {
  const authApolloClient = useApolloClient() as ApolloClient<
    Record<string, unknown>
  >;

  return {
    [APP_AUTH_RESOURCE.name]: authApolloClient,
    ...apolloClientsByResourceName,
  };
};
